<template>
  <header :class="navbarTypeClass()">
    <div
      ...
      ${this.$store.themeSettingsStore.menuLayout === 'horizontal' && window.width > 1280 ? 'py-1' : 'md:py-6 py-3'}
      `"
    >
      <div class="flex justify-between items-center h-full">
        ...
        <Mainnav v-if="this.$store.themeSettingsStore.menuLayout === 'horizontal' && window.width > 1280" />
